...
func main() {
	username := "admin"
	token := "3c04b3ed086fd58ee0424f42d213ba5a5d7c63a4"
	filehash := "e6db5c41c6d086335919ab6018b11cc1106e8c28"
	...
	// 3. 请求分块上传接口
	filename := "/home/tt/Downloads/go1.13.linux-amd64.tar.gz"
	...
	resp, err = http.PostForm(
		...
		url.Values{
			...
			"filehash": {filehash},
			"filesize": {"120050424"},
			"filename": {"go1.13.linux-amd64.tar.gz"},
			"uploadid": {uploadID},
		})
